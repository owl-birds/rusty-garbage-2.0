...
pub fn main() {
    ...
    println!("AREA OF RECT: {} square units", rect_area_2(dimensions_1));
    ...
    println!("AREA OF RECT: {} square units", rect_area_3(&dimensions_2));
    ...
    let rect_1 = RectangleTwo {
        width: 40,
        height: 20,
    };
    println!("reactangle with Debug functionality: {:?}", rect_1);
    println!("reactangle with Debug functionality: {:#?}", rect_1);
    ...
    println!("println reactangle with Debug functionality: {:#?}", rect_2); // println takes references
