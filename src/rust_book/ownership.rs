...
pub fn calculate_length(s: &String) -> usize { // s is a reference to a Strin
...
pub fn change(some_string: &mut String){ // mutable
...
pub fn first_word(s : &str) -> &str { // returning the index at the end of the first word
